...
export class ApiCallsService {
   ...
   private getResponseData(reponse: Observable<Response>): Observable<any> {
      return reponse.map((response: Response) => {
    ...
    */
   public authPost(body: models.Credentials): Observable<{}> {
      return this.getResponseData(this.authPostWithHttpInfo(body));
   }
    ...
    */
   public registerPost(body: models.GamifiedApplication): Observable<{}> {
      return this.getResponseData(this.registerPostWithHttpInfo(body));
	}
